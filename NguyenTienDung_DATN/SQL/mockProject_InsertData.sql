...
VALUES 
                        ...
                        ('$2a$10$W2neF9.6Agi6kAKVq8q3fec5dHW8KUA.b0VSIGdIZyUravfLpyIFi', 	true, '2023-01-04 12:00:00', 'USER'),
						('$2a$10$W2neF9.6Agi6kAKVq8q3fec5dHW8KUA.b0VSIGdIZyUravfLpyIFi', 	true, '2023-01-04 12:00:00', 'USER'),
                        ('$2a$10$W2neF9.6Agi6kAKVq8q3fec5dHW8KUA.b0VSIGdIZyUravfLpyIFi', 	true, '2023-01-06 12:00:00', 'USER');
                        
    
-- Chèn dữ liệu mẫu vào bảng NguoiDung
INSERT INTO `NguoiDung` (`MaNguoiDung`, `HoTen`, 	`SoDienThoai`, `Email`)
VALUES 
                        (1,             'Hoàng Văn Chiến',  	   		'123456789', 'bb.no1.dd@gmail.com'),
                        (2,             'Ngô Tuấn Hưng',    	 		'123456780', 'hungnt.020404@gmail.com'),
                        (3,             'Nguyễn Hữu Thắng',       		'123456781', 'huuthang9764@gmail.com'),
                        (4,             'Nguyễn Viết Hải',       		'123456781', 'nguyenviethai23052001@gmail.com'),
                        (5,             'Nguyễn Tiến Dũng',       		'123456781', 'dungnguyentien223@gmail.com'),
                        (6,             'Nguyễn Khắc Toàn',        		'123456781', 'toanbn10001@gmail.com');
...
INSERT INTO `SanPham` (`MaSanPham`,	`TenSanPham`, `Gia`, `SoLuongConLai`, `TrangThai`, 	`SoLuot`, `MoTaChiTiet`, `CongDung`,`ThanhPhan`,	`MaThuongHieu`, `MaLoaiSanPham`)
VALUES 
						(1, 		"tinh dầu cam"							, 		864000, 		10, 			true, 			'Sản phẩm tinh dầu', 		'Mô tả sản phẩm 1', 		2, 				2),
						(2, 		"tinh dầu bưởi xông phòng"				, 		7125000, 		2 , 			true, 			'Sản phẩm tinh dầu', 		'Mô tả sản phẩm 2', 		2, 				2),
						(3, 		"tinh dầu bưởi treo xe"					, 		1480000, 		20, 			true, 			'Sản phẩm tinh dầu', 		'Mô tả sản phẩm 3', 		2, 				2),
                        (4, 		"sản phẩm chăm sóc tóc"					, 		950000, 		20, 			true, 			'Sản phẩm chăm sóc tóc', 	'Mô tả sản phẩm 4', 		3, 				3),
						(5, 		"chất đốt"								, 		1190000, 		0, 				true, 			'Chất đốt', 				'Mô tả sản phẩm 5', 		3, 				3);
